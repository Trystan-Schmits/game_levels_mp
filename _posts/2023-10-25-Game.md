...
<audio id="audio" src="{{site.baseurl}}/audio/2023-10-23-Menu_Theme.mp3" preload="auto"></audio>
<audio id="audio2" src="{{site.baseurl}}/audio/box.wav" preload="auto"></audio>
...
<audio id="mainAudio" src="{{site.baseurl}}/audio/MainRoomAmbience.mp3" preload="auto"></audio>

<script type="module">
//import needed modules
import Character from "{{site.baseurl}}/myScripts/GameScripts/CharacterMovement.js";
import Object from "{{site.baseurl}}/myScripts/GameScripts/CreateObject.js";
import light from "{{site.baseurl}}/myScripts/GameScripts/Lights.js";
import {Display, subDisplay} from "{{site.baseurl}}/myScripts/GameScripts/Displays.js";
